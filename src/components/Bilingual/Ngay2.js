...
const VocabularyPopup = () => {
  ...
  return (
    <div className="flex flex-col h-[1/2] w-[680px] bg-[#f8f4f6] p-10 mx-auto rounded-3xl border shadow shadow-[#f5f2f4]">
      ...
      <div className=" flex justify-center"><h1 className="text-3xl font-bold mb-5 text-[#036ce0]">How to flirt with a girl</h1></div>
      
      <p className="text-lg leading-7 font-semibold text-[#600000]">
      <span className=" cursor-pointer underline" onClick={() => handlePhraseClick("Flirting")}>Flirting</span>{" "}
            with a girl can be {" "} 
    <span className=" cursor-pointer underline" onClick={() => handlePhraseClick("exciting")}>
        exciting
        </span>{" "} 
        and fun. Here are some quick tips to help you flirt with {" "} 
        <span className=" cursor-pointer underline" onClick={() => handlePhraseClick("confidence")}>
        confidence
        </span>
        : 
        <br></br>
    ...
    <li>Start with a genuine{" "}
        <span className=" cursor-pointer underline" onClick={() => handlePhraseClick("compliment")}>compliment</span>{" "}
    ...
    <li>
    Use {" "}
<span className=" cursor-pointer underline" onClick={() => handlePhraseClick("humor")}>
        humor
</span>{" "}
to make her laugh and create a connection.
    </li>

    <li>
    Show 
<span className=" cursor-pointer underline" onClick={() => handlePhraseClick("interest")}> interest </span>{" "}
        in her by asking questions and actively listening. 
    </li>


    <li>
        Use body language to your {" "}
        <span className=" cursor-pointer underline" onClick={() => handlePhraseClick("advantage")}>advantage</span>{" "}
        with eye contact and a warm smile. 
    </li>


    <li>
        Be confident but respectful, respecting her 
        <span className=" cursor-pointer underline" onClick={() => handlePhraseClick("boundaries")}> boundaries </span>
        . 
    </li>


    <li>
        Keep it light and playful with friendly teasing. 
    </li>
...
<span className=" cursor-pointer underline" onClick={() => handlePhraseClick("let your personality shine")}>
        let your personality shine
</span>
!
